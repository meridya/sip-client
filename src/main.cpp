...
// void terminateCall(const char *callerURI, const char *calleeURI);
...
int main() {
    ...
    CallDetails *callDetails=new CallDetails(to_string(rand()),"sip:1112@mockasterisk","sip:5555@mockasterisk");
...
void receiveSIPMessage(SipMessage message,CallDetails *callDetails) {
    ...
    if(message.getCallId()==callDetails->getCallId()){//Control if the incoming sip message's related to our call.
